...
namespace Comercio.NET.Controles
{
    public partial class MultiplePagosControl : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnMil = new Button
            {
                Text = "$5.000", // ✅ CAMBIADO: de "$1.000" a "$5.000"
                Location = new Point(130, 68), // ✅ AJUSTADO: Movido a la izquierda
                Size = new Size(50, 22),
            ...
            {
                Text = "$10.000", // ✅ CAMBIADO: de "$2.000" a "$10.000"
                Location = new Point(185, 68), // ✅ AJUSTADO: Movido a la izquierda
                Size = new Size(55, 22), // ✅ AUMENTADO: ancho para el texto más largo
                BackColor = Color.FromArgb(255, 193, 7),
                ForeColor = Color.Black,
                FlatStyle = FlatStyle.Flat,
                Font = new Font("Segoe UI", 7F, FontStyle.Bold)
            ...
            {
                Text = "$20.000", // ✅ CAMBIADO: de "$5.000" a "$20.000"
                Location = new Point(245, 68), // ✅ AJUSTADO: Movido a la izquierda
                Size = new Size(55, 22), // ✅ AUMENTADO: ancho para el texto más largo
                BackColor = Color.FromArgb(255, 193, 7),
                ForeColor = Color.Black,
                FlatStyle = FlatStyle.Flat,
            ...
            var btnCompletar = new Button
            {
                ...
                Location = new Point(310, 68), // ✅ AJUSTADO: de 340 a 310
        ...
        private void ActualizarEstadoBotones()
        {
            try
            {
                ...
                // ✅ MODIFICADO: Actualizar estado de botones rápidos (SIN btnTercio)
                bool hayImportePendiente = ImportePendiente > 0;
                btnMitad.Enabled = hayImportePendiente;
                // ❌ ELIMINADO: btnTercio.Enabled
                btnCompleto.Enabled = hayImportePendiente;

                System.Diagnostics.Debug.WriteLine($"⚙️ Estado botón Agregar: {(puedeAgregar ? "Habilitado" : "Deshabilitado")}");
            }
            catch (Exception ex)
            {
